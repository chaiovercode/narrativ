...
- **Multiple Visual Styles**: Choose from cinematic, vintage, cyberpunk, and more - or create your own
...
1. **Your Data Stays Local** - All generated content is stored on your machine
2. **Your Keys, Your Control** - Use your own API keys, no subscription fees
3. **Works Offline** (mostly) - Once research is cached, generate without internet
4. **No Rate Limits** - Generate as much as your API keys allow
...
- **Disk Space**: ~500MB for app + generated content
- **API Keys**: Google AI Studio (required), Tavily (optional), fal.ai (optional)
